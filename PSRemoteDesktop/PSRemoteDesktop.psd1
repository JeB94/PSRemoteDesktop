#
# Manifiesto del módulo 'PSRemoteDesktop'
#
# Generado por Jeb94
#
# Generado el 3/7/2017
#

@{

# Módulo de script o archivo de módulo binario asociado con este manifiesto.
RootModule = 'PSRemoteDesktop.psm1'
...
GUID = '6cf9b65f-412b-4f9f-b813-2fae3ce22c51'
...
# Minimum version of Microsoft .NET Framework required by this module. Este requisito previo únicamente es válido para la edición de escritorio de PowerShell.
# DotNetFrameworkVersion = ''

# Minimum version of the common language runtime (CLR) required by this module. Este requisito previo únicamente es válido para la edición de escritorio de PowerShell.
# CLRVersion = ''
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/JeB94/PSRemoteDesktop/blob/master/LICENSE'

        # Una dirección URL al sitio web principal de este proyecto.
        ProjectUri = 'https://github.com/JeB94/PSRemoteDesktop'
